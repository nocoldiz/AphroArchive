...
export const PROMPT_PRESETS: Record<string, Partial<BuilderState> & { description?: string; nsfwScore?: number }> = {
  ...
  'alien-abduction-lab': {
    ...
    nsfwScore: 95,
    numChars: 1,
    chars: [{ gender: 'girl', age: '20', ethnicity: 'pale nordic, porcelain skin, light eyes', hair: 'long hair', eyes: 'blue eyes', body: 'petite and delicate, 5\'1, small frame', breasts: 'small breasts', clothing: 'completely nude, bare skin, cold sweat', expression: 'shocked ahegao, eyes crossed, tears of unwanted pleasure' }],
  ...
  'kidnap-van-torture': {
    ...
    numChars: 2,
    chars: [
      { gender: 'girl', age: '19', ethnicity: 'japanese idol, flawless, cute yet lewd', hair: 'long hair', eyes: 'violet eyes', body: 'petite and delicate, 5\'1, small frame', breasts: 'small breasts', clothing: 'torn clothes, panties around one ankle, blindfold and gag', expression: 'crying from pleasure and pain, mascara run' },
      { gender: 'man', age: '35', ethnicity: 'middle eastern', hair: 'short hair', eyes: 'brown eyes', body: 'muscular', breasts: 'flat chest', clothing: 'completely nude, bare skin', expression: 'cold sadistic grin' }
    ],
  ...
  'torture-interrogation-lab': {
    ...
    nsfwScore: 96,
    numChars: 1,
    chars: [{ gender: 'girl', age: '23', ethnicity: 'ebony goddess, rich dark skin, full lips', hair: 'long hair', eyes: 'hazel eyes', body: 'perfect pornstar body, enhanced curves', breasts: 'huge breasts', clothing: 'nude and covered in drying cum, heavy metal restraints', expression: 'broken ahegao, tongue out, sobbing' }],
  ...
  'parasite-oviposition-captive': {
    ...
    nsfwScore: 97,
    numChars: 1,
    chars: [{ gender: 'girl', age: '21', ethnicity: 'latina fire, caramel skin, thick curves', hair: 'long hair', eyes: 'brown eyes', body: 'body built for breeding, fertile hips, soft belly', breasts: 'large breasts', clothing: 'completely nude, bare skin, slime coated and glistening', expression: 'ecstatic orgasm, mouth open screaming, mind shattered' }],
  ...
  'black-site-breeding-cattle': {
    ...
    nsfwScore: 94,
    numChars: 1,
    chars: [{ gender: 'girl', age: '18', ethnicity: 'asian beauty, smooth pale skin, dark hair', hair: 'medium hair', eyes: 'brown eyes', body: 'slim thick hourlass figure, tiny waist', breasts: 'medium breasts', clothing: 'nude except heavy collar and wrist cuffs, body writing "BREEDING STOCK"', expression: 'desperate needy pleading eyes, broken' }],
