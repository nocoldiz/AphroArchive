...
function card(v) {
  ...
  return tpl('video-card', {
    ...
    thumbDelBtn:  `<button class="cta-btn cta-del" onclick="event.preventDefault();event.stopPropagation();deleteVideoFromCard('${v.id}','${escA(v.name)}')" title="Delete video"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/></svg></button>`,
    thumbDescBtn: `<button class="cta-btn" onclick="event.preventDefault();event.stopPropagation();describeVideoThumb('${v.id}')" title="Describe with AI"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button>`,
  });
}
