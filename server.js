...
const server = http.createServer(async (req, res) => {
  ...
  const spaRoutes = /^\/(bookmarks|duplicates|vault|folders|recent|collections|scraper|settings|database|actors|studios|favourites|video\/|tag\/|cat\/|actor\/|studio\/|collection\/)/;
